...
export default (sequelize, DataTypes) => {
  class HealthDeclaration extends Model {
    ...
    static associate(models) {
      // Each HealthDeclaration record belongs to exactly one User
      // `userId` is the foreign key in this table
      HealthDeclaration.belongsTo(models.User, {
  ...
  HealthDeclaration.init(
    ...
    },
    {
      ...
      modelName: "HealthDeclaration", // Model name used internally
      tableName: "forms_health_declaration", // Exact table name in DB
