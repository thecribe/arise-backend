...
export default (sequelize, DataTypes) => {
  ...
  OtherDeclaration.init(
    ...
    },
    {
      ...
      modelName: "OtherDeclaration", // Model name used internally
      tableName: "forms_other_declarations", // Exact table name in DB
