...
export default (sequelize, DataTypes) => {
  class Confidentility extends Model {
    /**
    ...
    static associate(models) {
      ...
      Confidentility.belongsTo(models.User, {
  ...
  Confidentility.init(
    ...
    },
    {
      ...
      modelName: "Confidentility", // Model name used internally
      tableName: "forms_confidentility", // Exact table name in DB
      timestamps: true, // Adds createdAt & updatedAt
    },
  );
  return Confidentility;
};
