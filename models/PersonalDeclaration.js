...
export default (sequelize, DataTypes) => {
  ...
  PersonalDeclaration.init(
    ...
    },
    {
      ...
      modelName: "PersonalDeclaration", // Model name used internally
      tableName: "forms_personal_declaration", // Exact table name in DB
