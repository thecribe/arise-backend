...
export default (sequelize, DataTypes) => {
  ...
  DisabilityAct.init(
    ...
    },
    {
      ...
      modelName: "DisabilityAct", // Model name used internally
      tableName: "forms_disability_act", // Exact table name in DB
      timestamps: true, // Adds createdAt & updatedAt
    },
  );
  return DisabilityAct;
};
