...
export default (sequelize, DataTypes) => {
  class WorkingTime extends Model {
    ...
    static associate(models) {
      // Each WorkingTime record belongs to exactly one User
  ...
  WorkingTime.init(
    ...
    },
    {
      ...
      modelName: "WorkingTime", // Model name used internally
      tableName: "forms_working_time", // Exact table name in DB
